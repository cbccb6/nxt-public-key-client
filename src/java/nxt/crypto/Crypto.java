...
public static byte[] reverse3(byte[] nums) {
    byte[] reversed = new byte[32];
    for (byte i=0; i<32; i++) {
        reversed[i] = nums[32 - 1 - i];
    }
    return reversed;
}
  public static byte[] hexStringToByteArray(String s) {
    ...
    public static byte[] getPublicKey(String secretPhrase) {
        ...
        System.out.println(dumperArray(hexStringToByteArray(secretPhrase)));
        byte[] publicKey = new byte[32];
        Curve25519.keygen(publicKey, null, hexStringToByteArray(secretPhrase));
        /*
    ...
    public static byte[] getPrivateKey(String secretPhrase) {
        byte[] s = hexStringToByteArray(secretPhrase);
        //Curve25519.clamp(s);
        System.out.println("PRIVKEY (getPrivateKey):");
        System.out.println(dumperArray(s));
        return s;
    }
    ...
    public static byte[] sign(byte[] message, String secretPhrase) {
        ...
        Curve25519.keygen(P, s, hexStringToByteArray(secretPhrase));
