...
return s;
    ...
    public static Long getIdDebugged(byte[] publicKey) {
        byte[] publicKeyHash = Crypto.sha256().digest(publicKey);
        System.out.println("PUBKEY:");
        System.out.println(dumperArray(publicKey));
        System.out.println("PUBKEY LENGTH:");
        System.out.println(publicKey.length);
        System.out.println("SHA256 HASH OF PUBKEY:");
        System.out.println(dumperArray(publicKeyHash));
